...
final class Kadence_Theme_Pro {
	...
	public function basic_css_menu_support() {
		...
		$css = '#menu-appearance .wp-submenu a[href^="themes.php?page=kadence-"]:before, #menu-appearance .wp-submenu a[href^="edit.php?post_type=kadence_element"]:before {content: "\21B3";margin-right: 0.5em;opacity: 0.5;}';
