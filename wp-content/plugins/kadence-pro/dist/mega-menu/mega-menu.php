...
class Mega_Menu {
		...
		if ( $data['mega_menu'] ) {
			...
			if ( is_array( $data['menu_dropdown_item_color'] ) ) {
				...
				if ( isset( $data['menu_dropdown_item_color']['active'] ) && ! empty( $data['menu_dropdown_item_color']['active'] ) ) {
					$css->set_selector( '.header-navigation .header-menu-container #menu-item-' . $item->ID . '.kadence-menu-mega-enabled > .sub-menu li.current-menu-item > a' );
			...
			if ( is_array( $data['menu_dropdown_item_background'] ) ) {
				if ( isset( $data['menu_dropdown_item_background']['color'] ) && ! empty( $data['menu_dropdown_item_background']['color'] ) ) {
					$css->set_selector( '.header-navigation .header-menu-container #menu-item-' . $item->ID . '.kadence-menu-mega-enabled > .sub-menu a' );
				...
				if ( isset( $data['menu_dropdown_item_background']['hover'] ) && ! empty( $data['menu_dropdown_item_background']['hover'] ) ) {
					$css->set_selector( '.header-navigation .header-menu-container #menu-item-' . $item->ID . '.kadence-menu-mega-enabled > .sub-menu a:hover' );
			...
			if ( isset( $data['menu_dropdown_item_divider'] ) && is_array( $data['menu_dropdown_item_divider'] ) && isset( $data['menu_dropdown_item_divider']['width'] ) ) {
				...
				$css->set_selector( '.header-navigation .header-menu-container #menu-item-' . $item->ID . '.kadence-menu-mega-enabled > .sub-menu > li > a, .header-navigation .header-menu-container #menu-item-' . $item->ID . '.kadence-menu-mega-enabled li' );
	...
	public function apply_menu_title_changes( $title, $item, $args, $depth ) {
		...
		if ( isset( $data['menu_icon_svg'] ) && ! empty( $data['menu_icon_svg'] ) ) {
			$title .= '<span class="menu-label-icon-wrap"><span class="menu-label-icon">' . $data['menu_icon_svg'] . '</span></span>';
		}
