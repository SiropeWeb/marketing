...
class Header_Addons {
	...
	public function generate_pro_header_css() {
		...
		if ( ! is_user_logged_in() || ( is_customize_preview() && 'out' === kadence()->option( 'header_account_preview' ) ) ) {
			...
			$css->set_selector( '.header-account-button .nav-drop-title-wrap, .header-account-wrap > .header-account-button' );
			...
			$css->set_selector( '.header-account-wrap .header-account-button' );
			...
			$css->set_selector( '.header-account-wrap .header-account-button:hover' );
			...
			// Transparent header.
			$css->set_selector( '.transparent-header .header-account-wrap .header-account-button' );
			...
			$css->set_selector( '.transparent-header .header-account-wrap .header-account-button:hover' );
			...
			$css->set_selector( '.header-account-in-wrap .header-account-button' );
			$css->add_property( 'text-decoration', 'none' );
			$css->add_property( 'box-shadow', 'none' );
			...
			$css->set_selector( '.header-account-in-wrap .header-account-button:hover' );
			...
			$css->set_selector( '.header-account-in-wrap .header-account-button .header-account-label, .header-account-in-wrap .header-account-button .header-account-username' );
			...
			// Transparent header.
			$css->set_selector( '.transparent-header .header-account-in-wrap .header-account-button' );
			...
			$css->set_selector( '.transparent-header .header-account-in-wrap .header-account-button:hover' );
		...
		$css->add_property( 'border', '0' );
		$css->set_selector( '.widget-toggle-open:hover' );
		...
		$css->add_property( 'padding-right', '5px' );
		$css->set_selector( '.widget-toggle-open .widget-toggle-label:empty' );
		...
		$css->add_property( 'text-decoration', 'none' );
		$css->set_selector( '#widget-drawer .drawer-inner .header-widget2 .widget-title' );
		...
		$css->set_selector( '#widget-drawer .drawer-inner .header-widget2 a, #widget-drawer .drawer-inner .header-widget2 .drawer-sub-toggle' );
		$css->add_property( 'color', $css->render_color( kadence()->sub_option( 'header_widget2_link_colors', 'color' ) ) );
		$css->set_selector( '#widget-drawer .drawer-inner .header-widget2 a:hover, #widget-drawer .drawer-inner .header-widget2 .drawer-sub-toggle:hover' );
