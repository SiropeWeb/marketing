...
if ( ! class_exists( 'KT_PW_CMB2_Field_Select2' ) ) {
	...
	class KT_PW_CMB2_Field_Select2 {
		...
		public function setup_admin_scripts() {
			wp_register_script( 'ktrc-select3', KADENCE_WOO_EXTRAS_URL . 'classes/cmb2_select2/select2.js', array( 'jquery-ui-sortable' ), '4.0.3' );
			wp_enqueue_script( 'kt-select2-init', KADENCE_WOO_EXTRAS_URL . 'classes/cmb2_select2/cmb_select2_script.js', array( 'cmb2-scripts', 'ktrc-select3' ), self::VERSION );
			wp_enqueue_style( 'kt-select2', KADENCE_WOO_EXTRAS_URL . 'classes/cmb2_select2/cmb_select2_styles.css', false, self::VERSION );
		}
	}
