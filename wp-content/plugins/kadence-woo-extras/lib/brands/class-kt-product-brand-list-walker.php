<?php
/**
 * * KT_Product_Brand_List_Walke class
 */
...
/**
	 ...
	 */
	class KT_Product_Brand_List_Walker extends Walker {
		...
		public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
			...
			$output .= '"><a href="' . get_term_link( $cat_id, 'product_brands' ) . '">' . apply_filters( 'list_product_cats', $cat->name, $cat ) . '</a>';
