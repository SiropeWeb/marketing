...
if ( ! class_exists( 'Kadence_Plugin_API_Manager' ) ) {
	...
	class Kadence_Plugin_API_Manager {
		...
		public function validate_options( $input ) {
			...
			$current_product_id = $input['product_id'] ? trim( $input['product_id'] ) : '';
			$settings = array();
...
$kt_plugin_api->add_product( 'kadence_gutenberg_pro_activation', 'kt_api_manager_kadence_gutenberg_pro_data', 'kadence_gutenberg_pro', 'Kadence Blocks Pro' );
